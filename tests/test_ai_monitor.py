...
def test_ai_monitor_frontend_is_registered_beside_contract_monitor() -> None:
    ...
    assert '"/assets/ai-monitor.js?v=20260828-treasury-tenor2"' in entrypoint
    ...
    assert 'src="/assets/ai-monitor.js?v=20260828-treasury-tenor2"' in legacy_index
    assert 'href="/assets/ai-monitor.css?v=20260828-treasury-tenor2"' in component
