...
def build_platform_indicator_source(
    ...
    lines.extend(
        [
            ...
            '    risk_stop_atr_multiplier = float(params["risk_stop_atr_multiplier"])',
            '    risk_take_profit_atr_multiplier = float(params["risk_take_profit_atr_multiplier"])',
            ...
            "    risk = {\"stop_distance\": risk_atr_value * risk_stop_atr_multiplier, \"take_profit_distance\": risk_atr_value * risk_take_profit_atr_multiplier}",
            "    if not filters_pass:",
