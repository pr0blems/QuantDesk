...
from .application.ai_monitor import (
    aggregate_news_candidates as score_news_candidates,
)
from .application.ai_monitor import (
    annotate_event_cluster_selection as mark_event_cluster_selection,
)
from .application.ai_monitor import (
    configured_indicator_policy as evaluate_configured_indicator_policy,
)
from .application.ai_monitor import (
    filter_monitored_candidates as apply_monitor_symbol_allowlist,
)
from .application.ai_monitor import (
    historical_closed_settlement_price as resolve_historical_closed_settlement_price,
)
from .application.ai_monitor import (
    historical_settlement_price as resolve_historical_settlement_price,
)
...
from .application.ai_monitor import (
    multi_timeframe_technical_snapshot as evaluate_multi_timeframe_technical,
)
from .application.ai_monitor import (
    news_actionability_snapshot as classify_news_actionability,
)
from .application.ai_monitor import (
    news_event_cluster_id as build_news_event_cluster_id,
)
from .application.ai_monitor import (
    prediction_adaptive_path_exit as calculate_prediction_adaptive_path_exit,
)
from .application.ai_monitor import (
    prediction_cost_breakdown as calculate_prediction_cost_breakdown,
)
from .application.ai_monitor import (
    prediction_cost_settings as normalize_prediction_cost_settings,
)
from .application.ai_monitor import (
    prediction_estimated_cost_bps as estimate_prediction_cost_bps,
)
from .application.ai_monitor import (
    prediction_net_outcome as calculate_prediction_net_outcome,
)
from .application.ai_monitor import (
    prediction_outcome as calculate_prediction_outcome,
)
from .application.ai_monitor import (
    prediction_path_metrics as calculate_prediction_path_metrics,
)
from .application.ai_monitor import (
    prediction_price_barrier_exit as calculate_prediction_price_barrier_exit,
)
from .application.ai_monitor import (
    prediction_score_exit_price as resolve_prediction_score_exit_price,
)
from .application.ai_monitor import (
    prediction_score_exit_signal as detect_prediction_score_exit,
)
from .application.ai_monitor import (
    prediction_settlement_cost_config as resolve_prediction_settlement_cost_config,
)
from .application.ai_monitor import (
    prediction_soft_exit_policy as resolve_prediction_soft_exit_policy,
)
from .application.ai_monitor import (
    prepare_candidate_news_triggers as prepare_candidate_admission,
)
from .application.ai_monitor import (
    readiness_cost_config as conservative_readiness_cost_config,
)
from .application.ai_monitor import (
    realtime_feature_payload as normalize_realtime_feature_payload,
)
from .application.ai_monitor import (
    resolved_news_event_cluster_id as resolve_news_event_cluster_id,
)
from .application.ai_monitor import (
    select_directional_candidates_with_technical_context as select_directional_news_candidates,
)
from .application.ai_monitor import (
    settlement_exit_subreason as normalize_settlement_exit_subreason,
)
from .application.ai_monitor import (
    utc_event_iso as format_utc_event_iso,
)
from .application.ai_monitor import (
    virtual_risk_plan_snapshot as build_virtual_risk_plan,
)
...
from .infrastructure.persistence.ai_monitor_prediction_settlement import (
    backfill_prediction_path_metrics as persist_prediction_path_metrics,
)
from .infrastructure.persistence.ai_monitor_prediction_settlement import (
    reopen_legacy_prediction_settlements as persist_reopened_legacy_predictions,
)
from .infrastructure.persistence.ai_monitor_prediction_settlement import (
...
prediction_soft_exit_policy = resolve_prediction_soft_exit_policy
    ...
    *,
    ...
    for prediction in predictions:
        ...
        if policy_key not in candidate_cache:
            ...
            directional = score_news_candidates(
                [
                    row
...
virtual_risk_plan_snapshot = build_virtual_risk_plan
...
prediction_outcome = calculate_prediction_outcome
prediction_cost_settings = normalize_prediction_cost_settings
readiness_cost_config = conservative_readiness_cost_config
prediction_settlement_cost_config = resolve_prediction_settlement_cost_config
prediction_cost_breakdown = calculate_prediction_cost_breakdown
prediction_estimated_cost_bps = estimate_prediction_cost_bps
prediction_net_outcome = calculate_prediction_net_outcome
prediction_path_metrics = calculate_prediction_path_metrics
prediction_price_barrier_exit = calculate_prediction_price_barrier_exit

prediction_adaptive_path_exit = calculate_prediction_adaptive_path_exit
adaptive_exit_precedes = should_prefer_adaptive_exit
settlement_exit_subreason = normalize_settlement_exit_subreason
prediction_score_exit_signal = detect_prediction_score_exit
prediction_score_exit_price = resolve_prediction_score_exit_price
...
historical_settlement_price = resolve_historical_settlement_price
historical_closed_settlement_price = resolve_historical_closed_settlement_price
...
def _compact_historical_outcome(
    ...
    return {
        "event_cluster_id": resolve_news_event_cluster_id(
...
def frozen_market_ablation_summary(
    ...
    *,
    ...
    states = (
        ...
        if causal_replay
        else [classify_ablation_signal_state(item) for item in frozen_items]
    )
...
def historical_opportunity_fact_analytics(
    ...
    *,
    ...
    event_cluster_by_prediction = {
        int(prediction_id): resolve_news_event_cluster_id(
            stored_cluster_id,
            news_ids,
...
reopen_legacy_prediction_settlements = persist_reopened_legacy_predictions
backfill_prediction_path_metrics = persist_prediction_path_metrics

aggregate_news_candidates = score_news_candidates
news_actionability_snapshot = classify_news_actionability
news_event_cluster_id = build_news_event_cluster_id
resolved_news_event_cluster_id = resolve_news_event_cluster_id

configured_indicator_policy = evaluate_configured_indicator_policy
match_configured_indicators = evaluate_configured_indicators
multi_timeframe_technical_snapshot = evaluate_multi_timeframe_technical
select_directional_candidates_with_technical_context = (
    select_directional_news_candidates
)
...
def _scan_opportunities(
    ...
    news_scoring_service = NewsScoringService(
        aggregate=score_news_candidates,
    ...
    eligible_candidates, reused_news_skipped = prepare_candidate_admission(
        ...
        now=now,
        actionability=classify_news_actionability,
    )
