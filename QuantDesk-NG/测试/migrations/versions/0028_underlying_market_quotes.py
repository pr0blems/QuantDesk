...
Revision ID: 0028_underlying_quotes
Revises: 0027_order_depth_pool
"""
...
revision: str = "0028_underlying_quotes"
down_revision: str | None = "0027_order_depth_pool"
...
def downgrade() -> None:
    _require_mysql()
    op.drop_index(
        "ix_underlying_market_quotes_time", table_name="underlying_market_quotes"
    )
