...
def _build_repository(engine: Engine, tmp_path, closes: list[float], *, milliseconds: bool = True):
...
def test_all_strategies_return_json_safe_results(repository_factory, strategy_id, params) -> None:
...
def test_equity_drawdown_uses_constant_time_running_peak(repository_factory, monkeypatch) -> None:
