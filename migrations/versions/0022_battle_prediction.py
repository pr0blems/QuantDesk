...
Revision ID: 0022_battle_prediction
Revises: 0021_live_risk_defaults
"""
...
revision: str = "0022_battle_prediction"
down_revision: str | None = "0021_live_risk_defaults"
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("model_key", "version"),
        mysql_engine="InnoDB",
        mysql_charset="utf8mb4",
    )
    op.execute(
        f"""INSERT INTO prediction_model_versions(
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            ...
            name="uq_prediction_feature_symbol_time_schema",
        ),
        mysql_engine="InnoDB",
        mysql_charset="utf8mb4",
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name="fk_battle_predictions_model_version",
        ),
